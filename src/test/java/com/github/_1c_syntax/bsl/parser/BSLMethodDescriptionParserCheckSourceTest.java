...
//      .containsRule(BSLDescriptionParser.RULE_description, 1)
      .containsRule(BSLDescriptionParser.RULE_descriptionString, 15)
      .containsRule(BSLDescriptionParser.RULE_examples, 1)
      .containsRule(BSLDescriptionParser.RULE_examplesString, 30)
      .containsRule(BSLDescriptionParser.RULE_parameters, 1)
      ...
      .containsRule(BSLDescriptionParser.RULE_typeDescription, 16)
...
//      .containsRule(BSLDescriptionParser.RULE_description, 1)
      ...
      .containsRule(BSLDescriptionParser.RULE_examples, 0)
      ...
      .containsRule(BSLDescriptionParser.RULE_typeDescription, 1)
...
//      .containsRule(BSLDescriptionParser.RULE_description, 1)
      ...
      .containsRule(BSLDescriptionParser.RULE_typeDescription, 7)
...
//      .containsRule(BSLDescriptionParser.RULE_description, 1)
      ...
      .containsRule(BSLDescriptionParser.RULE_typeDescription, 4)
...
//      .containsRule(BSLDescriptionParser.RULE_description, 1)
      ...
      .containsRule(BSLDescriptionParser.RULE_examples, 0)
      .containsRule(BSLDescriptionParser.RULE_examplesString, 0)
      .containsRule(BSLDescriptionParser.RULE_parameters, 0)
      ...
      .containsRule(BSLDescriptionParser.RULE_typeDescription, 266)
...
//      .containsRule(BSLDescriptionParser.RULE_description, 1)
      ...
      .containsRule(BSLDescriptionParser.RULE_typeDescription, 12)
