...
class SDBLParserCheckSourceTest {
  ...
  void testSelect01() {
    testParser.assertThatFile("sdbl/select01.sdbl")
      ...
      .containsRule(SDBLParser.RULE_indexingSet, 0)
      .containsRule(SDBLParser.RULE_indexingItem, 0)
      .containsRule(SDBLParser.RULE_orderBy, 0)
      .containsRule(SDBLParser.RULE_ordersByExpression, 0)
      ...
      .containsRule(SDBLParser.RULE_predicate, 28)
      .containsRule(SDBLParser.RULE_expressionList, 0)
      .containsRule(SDBLParser.RULE_expressionListItem, 0)
      ...
      .containsRule(SDBLParser.RULE_rightJoin, 0)
      .containsRule(SDBLParser.RULE_leftJoin, 1)
      .containsRule(SDBLParser.RULE_innerJoin, 1)
      .containsRule(SDBLParser.RULE_fullJoin, 0)
  ...
  void testSelect02() {
    testParser.assertThatFile("sdbl/select02.sdbl")
      ...
      .containsRule(SDBLParser.RULE_predicate, 5)
      .containsRule(SDBLParser.RULE_expressionList, 3)
      .containsRule(SDBLParser.RULE_expressionListItem, 6)
      ...
      .containsRule(SDBLParser.RULE_rightJoin, 0)
      .containsRule(SDBLParser.RULE_leftJoin, 0)
      .containsRule(SDBLParser.RULE_innerJoin, 0)
      .containsRule(SDBLParser.RULE_fullJoin, 0)
  ...
  void testSelect03() {
    testParser.assertThatFile("sdbl/select03.sdbl")
      ...
      .containsRule(SDBLParser.RULE_valueFunction, 0)
      .containsRule(SDBLParser.RULE_castFunction, 0)
      .containsRule(SDBLParser.RULE_logicalExpression, 0)
      .containsRule(SDBLParser.RULE_predicate, 0)
      .containsRule(SDBLParser.RULE_expressionList, 0)
      .containsRule(SDBLParser.RULE_expressionListItem, 0)
      .containsRule(SDBLParser.RULE_dataSources, 1)
  ...
  void testSelect04() {
    testParser.assertThatFile("sdbl/select04.sdbl")
      ...
      .containsRule(SDBLParser.RULE_ordersByExpression, 1)
      .containsRule(SDBLParser.RULE_totalBy, 0)
      .containsRule(SDBLParser.RULE_totalsGroup, 0)
      .containsRule(SDBLParser.RULE_periodic, 0)
      ...
      .containsRule(SDBLParser.RULE_valueFunction, 0)
      .containsRule(SDBLParser.RULE_castFunction, 0)
      .containsRule(SDBLParser.RULE_logicalExpression, 2)
      .containsRule(SDBLParser.RULE_predicate, 2)
      .containsRule(SDBLParser.RULE_expressionList, 0)
      .containsRule(SDBLParser.RULE_expressionListItem, 0)
      .containsRule(SDBLParser.RULE_dataSources, 2)
      .containsRule(SDBLParser.RULE_dataSource, 2)
